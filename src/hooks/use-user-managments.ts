...
export const userKeys = {
  ...
  confidentialInfo: (userId: number) =>
    [...userKeys.detail(userId), "confidential"] as const,
  paymentChannels: (userId: number) =>
    [...userKeys.detail(userId), "payment-channels"] as const,
};
...
> => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.setQueryData(userKeys.confidentialInfo(variables.id), data);
    },
    onError: (error) => {
...
export const useAdminUsers = (
  filters: Omit<UsersFilterParams, "role"> = {}
) => {
  return useUsers({
    ...filters,
    role: "admin",
...
export const useActiveUsers = (
  filters: Omit<UsersFilterParams, "isActive"> = {}
) => {
  return useUsers({
    ...filters,
    isActive: true,

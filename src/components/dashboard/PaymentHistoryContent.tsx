...
interface PaymentHistoryContentProps {
    userId?: number; // Optional: filter by specific user ID (for non-admin users)
    isAdmin?: boolean; // Determines if user is admin
}
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                {isAdmin ? "View all bookings and their payment status" : "View your booking history"}
                            </CardDescription>
                        </div>
                        <Button
                            variant="outline"
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="space-y-2 text-sm">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="flex justify-between items-center">
                                                                <span className="text-muted-foreground">Booking Payment Status
